...
# Classe principal que define a tela de cadastro de saida
class TelaCadastroEntrada(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowTitle("Cadastro de Saída")  # Define o título da janela
        ...
        tituloFornecedor = QLabel("Cadastro de Saída")  # Texto do título
        ...
        nomeInput.setPlaceholderText("Nome do Fornecedor")  # Texto de exemplo
        formulario.addRow("Nome:", nomeInput)  # Adiciona o campo de nome

        cnpjInput = QLineEdit(self)
        cnpjInput.setPlaceholderText("CNPJ")  # Texto de exemplo
        formulario.addRow("CNPJ:", cnpjInput)  # Adiciona o campo de CNPJ

        enderecoInput = QLineEdit(self)
        enderecoInput.setPlaceholderText("Rua mosenhor tabosa")
        formulario.addRow("Endereço:",enderecoInput)

        numeroInput = QLineEdit(self)
        numeroInput.setPlaceholderText("1234")
        formulario.addRow("Nº:",numeroInput)

        complementoInput = QLineEdit(self)
        complementoInput.setPlaceholderText("Bloco 5, Apto 213")
        formulario.addRow("Complemento:",complementoInput)

        cidadeInput = QLineEdit(self)
        cidadeInput.setPlaceholderText("Fortaleza")
        formulario.addRow("Cidade:",cidadeInput)

        bairroInput = QLineEdit(self)
        bairroInput.setPlaceholderText("Bairro")
        formulario.addRow("Bairro:",bairroInput)

        telefoneInput = QLineEdit(self)
        telefoneInput.setPlaceholderText("Telefone")  # Texto de exemplo
        formulario.addRow("Telefone:", telefoneInput)  # Adiciona o campo de telefone

        emailInput = QLineEdit(self)
        emailInput.setPlaceholderText("E-mail")  # Texto de exemplo
        formulario.addRow("E-mail:", emailInput)  # Adiciona o campo de e-mail
